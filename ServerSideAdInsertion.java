...
public class ServerSideAdInsertion {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final List<Double> adBreakPlacements = Arrays.asList(5.0D,10.0D);
    ...
    private static GcsOutput createGcsOutput(String bucketName, String accessKey, String secretKey)
            throws BitmovinException {

        GcsOutput gcsOutput = new GcsOutput();
        gcsOutput.setBucketName(bucketName);
        gcsOutput.setAccessKey(accessKey);
        gcsOutput.setSecretKey(secretKey);
